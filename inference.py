...
# #         curr_ids = generated
# #         batch_size, seq_len = curr_ids.shape
...
# #         hidden_states = model.model.embed_tokens(curr_ids)
...
# #         causal_mask = torch.where(causal_mask, torch.finfo(hidden_states.dtype).min, 0.0)
        
# #         # Forward through transformer layers
# #         for i, layer in enumerate(model.model.layers):
# #             if i in omission_set:
# #                 continue
...
# #     print("=== Full model (no omissions) ===")
# #     response = generate_response(prompt, omission_set=set())
# #     print(f"Response:\n{response}\n")
    
# #     print("\n=== Omitting layers 10-15 ===")
# #     response = generate_response(prompt, omission_set=set(range(10, 16)))
# #     print(f"Response:\n{response}\n")
...
#     print("Layer 0: _ _ _  (all skip)")
#     print("Layer 1: a _ c")
#     print("Layer 2: _ b c")
#     print("Layer 3: _ b _")
#     print("Layer 4: a b _")
#     print("Head:    a b c  (all execute)")
